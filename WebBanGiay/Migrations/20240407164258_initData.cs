        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductDescription = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvokeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerID = table.Column<int>(type: "int", nullable: false),
                    InvokeDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InvokeTotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Username = table.Column<string>(type: "nvarchar(50)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invoke", x => x.InvokeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_InvokeDetail_Invoke_InvokeId",
                        column: x => x.InvokeId,
                        principalTable: "Invoke",
                        principalColumn: "InvokeId");
                    table.ForeignKey(
                        name: "FK_InvokeDetail_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoke_Username",
                table: "Invoke",
                column: "Username");

            migrationBuilder.CreateIndex(
                name: "IX_InvokeDetail_InvokeId",
                table: "InvokeDetail",
                column: "InvokeId");

            migrationBuilder.CreateIndex(
                name: "IX_InvokeDetail_ProductId",
                table: "InvokeDetail",
                column: "ProductId");
